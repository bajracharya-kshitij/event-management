		...
		<div id="list-event" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="fromDate" title="${message(code: 'event.fromDate.label', default: 'From Date')}" />
					
						<g:sortableColumn property="toDate" title="${message(code: 'event.toDate.label', default: 'To Date')}" />
				...
				<g:each in="${eventInstanceList}" status="i" var="eventInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${eventInstance.fromDate}" /></td>
					
						<td><g:formatDate date="${eventInstance.toDate}" /></td>
